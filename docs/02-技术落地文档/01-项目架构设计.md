...
export const useGameStore = defineStore('game', {
  ...
  getters: {
    ...
    expProgressPercent: (state) => {
      return Math.floor((state.plannerExp / getMaxExp(state.plannerLevel)) * 100);
    },
...
export const useSaveStore = defineStore('save', {
  ...
  actions: {
    ...
    createSave() {
      ...
      this.saves.push({ id: saveId, date: new Date(), preview: this.generatePreview(saveData) });
    },
