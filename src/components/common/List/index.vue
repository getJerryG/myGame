  ...
  >
    ...
    <template v-else>
      ...
      <ul
        ...
        class="list__content list__content--vertical"
      >
        <li
          ...
          :class="[
            {
              'list__item--selected':
                selectable && selectedKeys.includes(item[keyField]),
            },
        ...
        >
          ...
          <div class="list__item-content">
            <slot name="item" :item="item" :index="index">
              ...
              <div v-if="item[subtitleField]" class="list__item-subtitle">
                {{ item[subtitleField] }}
              </div>
            </slot>
          </div>
      ...
      <div
        ...
        class="list__content list__content--grid"
        :style="gridStyle"
      >
        <div
          v-for="(item, index) in items"
        ...
        >
          ...
          <div
            v-if="selectable"
            class="list__item-checkbox list__item-checkbox--grid"
          >
            <input
              type="checkbox"
              :checked="selectedKeys.includes(item[keyField])"
      ...
      <!-- 流式列表 -->
      <div
        v-else-if="layout === 'flow'"
        class="list__content list__content--flow"
      >
        <div
          v-for="(item, index) in items"
          :key="item[keyField] || index"
    ...
    <!-- 分页器 -->
    <div
      v-if="pagination && !loading && items.length > 0"
